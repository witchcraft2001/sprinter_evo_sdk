...
// fade out, затем управление уходит к штатной заставке игры. Логотип 256-цветный
...
#ifdef __SPRINTER__
  splash_sprinter();                  // заставка Sprinter перед штатной заставкой (один раз)
#endif
  title();
