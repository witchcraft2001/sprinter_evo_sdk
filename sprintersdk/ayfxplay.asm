...
afxFrame0
        ...
        LD B,#FF                         ;начало вывода значения
	ifndef TFM	;для TurboSound!!! выключено для TFM
       OUT (C),B ;AY #1(0)      ;т.к.может вырубиться при HY=#FF
...
;afxFrame1
        ...
        LD (IX+2),#FE           ;делаем время наибольшим-1
        LD (IX+3),#FF
...
afxFrame4
        ...
        DJNZ afxFrame4
        LD D,A
       LD BC,#FFFD                     ;читаем регистр микшера
        LD A,7
	ifdef TFM
	call waitstatus
	endif
