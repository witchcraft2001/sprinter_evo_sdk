//этот пример показывает опрос мыши и вывод указателя с использованием спрайта
//а также опрос джойстика и установку указателя мыши в новые координаты
...
void main(void)
{
	...
	//установка позиции и области перемещения мыши
	...
	while(1)
	{
		...
		//опрос джойстика и изменение координат мыши по нажатиям направлений
